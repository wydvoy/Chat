  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'border-ultra-light': 'var(--border-ultra-light)',
        'border-light-alpha': 'var(--border-light-alpha)',
        'border-medium-alpha': 'var(--border-medium-alpha)',
        'border-heavy-alpha': 'var(--border-heavy-alpha)',
